//
//  OrganizationChartContainerSection.swift
//
//
...
public struct OrganizationChartContainerSection {
    ...
    public init(dataStream: inout DataStream) throws {
        ...
        while true {
            ...
            guard id != OrganizationChartRecordId.containerSectionEnd.rawValue else {
                break
            }
